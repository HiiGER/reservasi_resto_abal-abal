        ...
        <footer id="footer" class="s-footer">  
            ...
            <div class="row s-footer__top row-x-center">
                <div class="column xl-4 lg-6 tab-8 mob-12">
                    <a href="../customer/reservation.php" class="btn btn--primary btn--large u-fullwidth">Book a Table</a>
                </div>
            </div>
            ...
            <div class="row s-footer__main-content">
                ...
                <div class="column xl-6 md-12 s-footer__block s-footer__about"> 
                    ...
                    <p>
                    Maillard telah menerima banyak pujian dari para kritikus dan tamu, 
                    dan telah menjadi salah satu restoran paling populer di kota ini. 
                    Jika Anda mencari pengalaman kuliner yang tak terlupakan, 
                    Maillard adalah tempat yang tepat untuk Anda.
                    </p>               
                ...
                <div class="column xl-6 md-12 s-footer__block s-footer__info">
                    <div class="row">
                        ...
                        <div class="column xl-6 lg-12">     
                            <h5>Contacts</h5>
                            <ul class="link-list">
                                <li><a href="mailto:#0">talenmukti03@gmail.com</a></li>
                                <li><a href="tel:+6289670364314">(62) 8967-0364-314</a></li>
                            </ul> 
                        </div>
                        <div class="column">                   
                            <h5>Opening Hours</h5>
            ...
            <div class="row s-footer__bottom">
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright">
                        <span>© Copyright Maillard 2024</span>
                    </p>
                </div>
