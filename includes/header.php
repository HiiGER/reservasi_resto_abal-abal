...
<head>
    ...
    <style>
        /* Styling untuk input date, time, dan file */
        input[type="date"],
        input[type="time"],
        input[type="file"] {
            width: 100%;
        ...
        /* Styling khusus untuk file input */
        input[type="file"] {
            padding: 5px;
        }
        ...
        <header class="s-header">
            ...
            <div class="s-header__block">
                ...
                <div class="s-header__logo">
                    <a class="logo" href="../customer/index.php">
                ...
                <div class="s-header__cta">
                    <a href="../customer/reservation.php" class="btn btn--primary s-header__cta-btn">Book a Table</a>                        
                </div>
            ...
            <nav class="s-header__nav">    
                ...
                <ul class="s-header__nav-links">
                    <li class="current"><a href="../customer/index.php">Home</a></li>
                    <li><a href="../customer/menu.php">Menu</a></li>
                    <li><a href="../customer/reservation.php">Reservations</a></li>
                    <li><a href="../customer/check_reservation.php">Check Reservations</a></li>
                </ul> <!-- s-header__nav-links -->    

                <div class="s-header__nav-bottom">

                    <h6>Beri Tanggapan Anda</h6>
                    <a href="../customer/ulasan.php">Form Review</a>
